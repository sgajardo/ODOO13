...
class HrHistoricWizard(models.TransientModel):
    ...
    def _get_period(self):
        for val in self:
            ...
            if date_from.month == date_to.month:
                ...
                val.period = '%.2d-%s al %.2d-%s' % (date_from.month, date_from.year, date_to.month, date_to.year)
    ...
    date_to = fields.Date(
        string='Hasta',
        required=True,
        default=lambda self: fields.Date.today() + relativedelta.relativedelta(months=1, day=1, days=-1))
